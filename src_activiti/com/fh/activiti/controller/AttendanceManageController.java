...
//				Staff staff=staffService.queryStaffByStaffCode(staffTransfer.getStaffCode());
...
//							variableList.add("提交");
				...
				actHiActinstQuery.createCriteria().andProcInstIdEqualTo(task.getProcessInstanceId());
