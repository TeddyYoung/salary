...
public interface StationTargetService {
	 ...
	 * @param pageNum
	 *            当前页
	 * @param stationTargetName
	 *            油站指标名称
	 * @param stationTargetLevel
	 *            油站指标级别
	 * @return
	 */
	Page findStationTargetsByPage(Page page, SellDataSearchVO searchVO);
	 ...
	 * @return
	 */
	StationTarget findStationTargetByStationCodeAndYearMonth(
