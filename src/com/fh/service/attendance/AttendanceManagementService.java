...
public interface AttendanceManagementService {
	 ...
	 * @return 分装好对应记录的分页对象
	 */
	Page findAttendanceManagementByPage(Page page, String yearMonth, String stationCode);

	/**
	 * 查询上个月所有考勤管理的记录
	 * @param yearMonth 月份条件
	 * @param stationCode 所属油站
	 * @return 分装好对应记录的List集合
	 */
	List<AttendanceManagement> findAllAttendanceManagementByCriteriaQuery(String yearMonth, String stationCode);
	 ...
	 * @return
	 */
	List<AttendanceManagement> findAllAttendanceManagementsByYearMonth(String yearMonth, String districtCode);
