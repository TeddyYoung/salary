...
public interface ChallengeBonusDao {
	 ...
	 * @return
	 */
	public List<ChallengeBonus> findChallengeBonusList(
	 ...
	 * @return
	 */
	public List<ChallengeBonus> findChallengeBonusPage(
			@Param("searchVO") ChallengeBonusSearchVO searchVO,
	 ...
	 * @return
	 */
	public int findCount(ChallengeBonusSearchVO searchVO);
