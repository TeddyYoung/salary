...
public class ZGTService {
	...
	public static Map<String, String> decryptPayCallbackData(String data) {
		...
		try {
			...
			customernumber		  	= formatString(result.get("customernumber")); 
			requestid			  	= formatString(result.get("requestid"));
			code				  	= formatString(result.get("code"));
			notifytype			  	= formatString(result.get("notifytype"));
			externalid			  	= formatString(result.get("externalid"));
			amount				  	= formatString(result.get("amount"));
			cardno				  	= formatString(result.get("cardno"));
			bankcode			  	= formatString(result.get("bankcode"));
			hmacYeepay			  	= formatString(result.get("hmac"));
	...
	public static Map<String, String> decryptCashCallbackData(String data) {
		...
		try {
			...
			customernumber		  	= formatString(result.get("customernumber")); 
			cashrequestid			= formatString(result.get("cashrequestid"));
			code			  		= formatString(result.get("code"));
			ledgerno				= formatString(result.get("ledgerno"));
			amount			  		= formatString(result.get("amount"));
			status			  		= formatString(result.get("status"));
			desc			  		= formatString(result.get("desc"));
			lastno				  	= formatString(result.get("lastno"));
			hmacYeepay			  	= formatString(result.get("hmac"));
