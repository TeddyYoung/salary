	...
	<form  action="<%=basePath%>activiti/execution.do" name="staffForm" id="staffForm" method="post" >
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<td style="width:120px;text-align: right;padding-top: 13px;">备注：</td>
				<td  style="width:120px;text-align: left;padding-top: 13px;">${staffTemp.remark}</td>
			</tr>
					<tr>
	...
	<table id="table_report" class="table table-striped table-bordered table-hover">
		...
		<c:choose>
			<c:when test="${not empty list}">
				...
				<td class='center'>${generalStaffLeaveOffice.historicActivityInstance.activityName} </td>
				<td class='center'>${generalStaffLeaveOffice.historicActivityInstance.assignee}</td>
				<td class='center'><fmt:formatDate value="${generalStaffLeaveOffice.historicActivityInstance.startTime}" pattern="yyyy-MM-dd HH:mm:ss" /> </td>
				<td class='center'><fmt:formatDate value="${generalStaffLeaveOffice.historicActivityInstance.endTime}" pattern="yyyy-MM-dd HH:mm:ss" /> </td>
				</tr>
				</c:forEach>
			</c:when>
			<c:otherwise>
