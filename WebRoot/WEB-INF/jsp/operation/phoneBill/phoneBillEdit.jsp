...
<body>
	<form  action="<%=basePath%>stationTarget/stationTargetSaveOrUpdate.do" name="stationTargetForm" id="stationTargetForm" method="post" >
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				...
				<td><input class="span10 date-picker" name="yearMonth" name="yearMonth"  value="${stationTarget.yearMonth }" type="text" data-date-format="yyyy-mm" style="width:205px;" placeholder="年份月份" title="年份月份"/></td>
			</tr>
			<tr>	
