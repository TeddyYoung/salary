...
<script type="text/javascript">
	...
	function importList() {
		bootbox.confirm("当前上传的Excel表格会自动将数据录入至上个月的数据中，请确认您上传的Excel表格是上个月的数据！", function(result) {
			if(result) {
				$("#storeCheckForm").attr("action", "<%=basePath%>storeCheck/importList.do");
				$("#storeCheckForm").submit();
			}
		});
	}
	...
	<div class="container-fluid" id="main-container">
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				<div class="row-fluid">
					<!-- 检索  -->
					<form action="<%=basePath%>storeCheck/storeCheckList.do" enctype="multipart/form-data"
						...
						<table>
							<tr>
								...
								<td style=""><a 
									class="btn btn-mini btn-info" onclick="searchStoreCheck();" style="margin-top:-11px;">查询</a></td>
								<td style=""><a
									class="btn btn-mini btn-info" onclick="saveOrUpdateStoreCheck();" style="margin-top:-11px;">便利店考核</a></td>
								<td>
									<input type="file" name="uploadFile" />
									<a class="btn btn-mini btn-info" onclick="importList();" style="margin-top:-11px;">导入Excel数据</a>
								</td>
								<td>
									<a class="btn btn-mini btn-info" href="<%=basePath%>common/downloadTemplate.do?fileType=13" style="margin-top:-11px;">模板下载</a>
								</td>
							</tr>
						</table>
