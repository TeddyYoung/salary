	...
	<form  action="<%=basePath%>stationLevel/stationlevelSaveOrUpdate.do" name="stationLevelForm" id="stationLevelForm" method="post" >
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				...
				<td><input type="text" name="stationLevelCode" id="stationLevelCode" placeholder="这里输入星级编号" value="" title="星级编号" maxlength="32" /></td>
			</tr>
			<tr>
				<td style="width:120px;text-align: right;padding-top: 13px;">星级名称：</td>
				<td><input type="text" name="stationLevelName" id="stationLevelName" placeholder="这里输入星级名称" value="" title="星级名称" maxlength="32" /></td>
			</tr>
			<tr>
				<td style="width:120px;text-align: right;padding-top: 13px;">经理奖金：</td>
				<td><input type="text" name="managerBonusAmt" id="managerBonusAmt" placeholder="这里输入经理奖金" value="" title="经理奖金" maxlength="32" /></td>
			</tr>
			<tr>
