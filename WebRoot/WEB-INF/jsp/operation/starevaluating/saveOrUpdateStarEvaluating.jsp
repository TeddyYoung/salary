...
<script type="text/javascript">
	...
	//取消
	function no() {
		window.location.href = "<%=basePath%>starEvaluating/starEvaluatingList.do";
	}
	...
	<div class="container-fluid" id="main-container">
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				<div class="row-fluid">
					<!-- 检索  -->
					<form action="<%=basePath%>starEvaluating/starEvaluatingRealSaveOrUpdate.do"
						name="starevaluatingForm" id="starevaluatingForm" method="post">
						<table>
							<tr>
									...
									<c:when test="${!empty stationTargetList}">
										<c:forEach items="${stationTargetList}" var="stationTarget" varStatus="vs">
											<tr>
												...
												<td class="center">
													<c:forEach items="${stationLevels}" var="stationLevel">
														<input type="radio" name="stationTargetList[${vs.index}].stationLevelCode"
														 	   <c:if test="${stationTarget.stationLevelCode==stationLevel.stationLevelCode}" >checked</c:if>
															   value="${stationLevel.stationLevelCode}" /><span class="lbl"></span>${stationLevel.stationLevelName}
													</c:forEach>								
												</td>
												<td class="center">
