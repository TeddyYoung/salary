		...
		<div id="zhongxin">
			<table id="table_report" class="table table-striped table-bordered table-hover">
				<tr>
					...
					<td><input type="text" name="holidayName" id="holidayName" placeholder="这里输入过节费名称" value="${holiday.holidayName}" title="过节费名称"  maxlength="32" /></td>
				</tr>
				<tr>
					<td style="width:120px;text-align: right;padding-top: 13px;">过节费金额<span style="color:red;">*</span>：</td>
					<td><input type="text" name="holidayMoney" id="holidayMoney" placeholder="这里输入过节费金额" value="<fmt:formatNumber type='number' value='${holiday.holidayMoney}' pattern='0.00' maxFractionDigits='2' />" title="过节费金额"  maxlength="32" /></td>
					<td colspan="2"></td>
				</tr>
				<tr>
