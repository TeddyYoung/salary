...
<body>
	<form  action="<%=basePath%>duty/dutySaveOrUpdate.do" name="dutyForm" id="dutyForm" method="post" >
		...
		<input type="hidden" name="sysCreateTime" value="${duty.sysCreateTime}" />
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td style="width:120px;text-align: right;padding-top: 13px;">职务编号：</td>
				<td><input type="text" name="dutyCode" id="dutyCode" placeholder="这里输入职务编号" value="${duty.dutyCode}" title="职务编号"  maxlength="32" /></td>
				<td style="width:120px;text-align: right;padding-top: 13px;">职务名称：</td>
				<td><input type="text" name="dutyName" id="dutyName" placeholder="这里输入职务名称" value="${duty.dutyName}" title="职务名称"  maxlength="32" /></td>
			</tr>
			<tr>
				...
				<td><select name="dutyType" id="dutyType" class="chzn-select" data-placeholder="请选择职务类型" style="vertical-align:top;width: 220px;"  title="职务类型">
								...
								<systab:dataDictionary codeType="duty_type" valueType="all">
									<option value="${dataDictionary.valuetype}"  ${dataDictionary.valuetype==duty.dutyType ? 'selected="selected"' : '' }>${dataDictionary.valuename}</option>
				...
				<td><select name="dutyNature" id="dutyNature" class="chzn-select" data-placeholder="请选择职务性质" style="vertical-align:top;width: 220px;"  title="职务性质">
								...
								<systab:dataDictionary codeType="duty_nature" valueType="all">
									<option value="${dataDictionary.valuetype}"  ${dataDictionary.valuetype==duty.dutyNature ? 'selected="selected"' : '' }>${dataDictionary.valuename}</option>
								</systab:dataDictionary>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td><input type="text" name="sort" id="sort" placeholder="这里输入排序" value="${duty.sort}" title="排序"  maxlength="32" /></td>
				<td style="width:120px;text-align: right;padding-top: 13px;">备注：</td>
				<td colspan="10"><input type="text" name="remark" id="remark" placeholder="这里输入备注" value="${duty.remark}" title="备注" maxlength="32"  /></td>
			</tr>
			<tr>
