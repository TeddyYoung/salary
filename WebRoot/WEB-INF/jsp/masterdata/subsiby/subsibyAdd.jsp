...
<!-- 				<td><input type="text" name="holidayName" id="holidayName" placeholder="这里输入补贴名称" value="" title="补贴名称"  maxlength="32" /></td> -->
				<td style="width:120px;text-align: right;padding-top: 13px;">补贴类型<span style="color:red;">*</span>：</td>
				<td>
					<select  name="type" id="type"  data-placeholder="请选择挑补贴类型"
			...
			<tr>
				...
				<td><input type="text" name="holidayMoney" id="holidayMoney" placeholder="这里输入补贴金额" value="" title="补贴金额"  maxlength="32" /></td>
				<td colspan="2"></td>
			</tr>
			<tr>
