...
<body>
	<form  action="<%=basePath%>standardBonusSetup/standardBonusSetupSaveOrUpdate.do" name="standardBonusSetupForm" id="standardBonusSetupForm" method="post" >
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td style="width:120px;text-align: right;padding-top: 13px;">起始达标率（%）：</td>
				<td><input type="text" name="startRate" id="startRate" placeholder="这里输入起始达标率（升）" value="" title="起始达标率（升）" maxlength="32" /></td>
				<td style="width:120px;text-align: right;padding-top: 13px;">封顶达标率（%）：</td>
				<td><input type="text" name="endRate" id="endRate" placeholder="这里输入封顶达标率（升）" value="" title="封顶达标率（升）" maxlength="32" /></td>
			</tr>
			<tr>
				<td style="width:120px;text-align: right;padding-top: 13px;">奖金基数（元）：</td>
				<td><input type="text" name="bonusAmt" id="bonusAmt" placeholder="这里输入奖金基数（元）" value="" title="奖金基数（元）" maxlength="32" /></td>
				<td style="width:120px;text-align: right;padding-top: 13px;">奖金系数：</td>
				<td><input type="text" name="bonusCoefficient" id="bonusCoefficient" placeholder="这里输入奖金系数（元）" value="" title="奖金系数（元）" maxlength="32" /></td>
			</tr>
			<tr>
			...
			<td style="width:120px;text-align: right;padding-top: 13px;">备注：</td>
				<td><input type="text" name="remark" id="remark" placeholder="这里输入备注" value="" title="备注" maxlength="32" /></td>
			</tr>
			<tr>
