...
<!-- 				<td><input type="text" name="planDay" id="planDay" placeholder="这里输入计划天数" value="" title="计划天数"  maxlength="32" /></td> -->
				<td colspan="2"></td>
			</tr>
			<tr>
				<td style="width:120px;text-align: right;padding-top: 13px;">基础目标<span style="color:red;">*</span>：</td>
				<td><input type="text" name="baseTarget" id="baseTarget" placeholder="这里输入基础目标" value="" title="基础目标"  maxlength="32" /></td>
<!-- 				<td style="width:120px;text-align: right;padding-top: 13px;">非油品总额<span style="color:red;">*</span>：</td> -->
<!-- 				<td><input type="text" name="nonOilTotalAmt" id="nonOilTotalAmt" placeholder="这里输入非油品总额" value="" title="非油品总额"  maxlength="32" /></td> -->
				<td style="width:120px;text-align: right;padding-top: 13px;">基础奖金<span style="color:red;">*</span>：</td>
				<td><input type="text" name="baseBonusAmt" id="baseBonusAmt" placeholder="这里输基础奖金" value="" title="基础奖金"  maxlength="32" /></td>
			</tr>
<!-- 			<tr> -->
<!-- 				<td style="width:120px;text-align: right;padding-top: 13px;">中间目标<span style="color:red;">*</span>：</td> -->
<!-- 				<td><input type="text" name="middleTarget" id="middleTarget" placeholder="这里输入中间目标" value="" title="中间目标"  maxlength="32" /></td> -->
<!-- 				<td style="width:120px;text-align: right;padding-top: 13px;">中间奖金<span style="color:red;">*</span>：</td> -->
<!-- 				<td><input type="text" name="middleBonusAmt" id="middleBonusAmt" placeholder="这里输入中间奖金" value="" title="中间奖金"  maxlength="32" /></td> -->
<!-- 			</tr> -->
			<tr>
				<td style="width:120px;text-align: right;padding-top: 13px;">挑战目标<span style="color:red;">*</span>：</td>
				<td><input type="text" name="challengeTarget" id="challengeTarget" placeholder="这里输入挑战目标" value="" title="挑战目标"  maxlength="32" /></td>
				<td style="width:120px;text-align: right;padding-top: 13px;">挑战奖金<span style="color:red;">*</span>：</td>
				<td><input type="text" name="challengeBonusAmt" id="challengeBonusAmt" placeholder="这里输入挑战奖金" value="" title="挑战奖金"  maxlength="32" /></td>
			</tr>
			<tr>
