	...
	<form  action="<%=basePath%>district/districtSaveOrUpdate.do" name="districtForm" id="districtForm" method="post" >
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				...
				<td><input type="text" name="districtCode" id="districtCode" placeholder="这里输入区域编号" value="" title="区域编号" maxlength="32" /></td>
			</tr>
			<tr>
				<td style="width:120px;text-align: right;padding-top: 13px;">区域名称：</td>
				<td><input type="text" name="districtName" id="districtName" placeholder="这里输入区域名称" value="" title="区域名称" maxlength="32" /></td>
			</tr>
			<!-- 
			<tr>
				<td style="width:120px;text-align: right;padding-top: 13px;">区域级别：</td>
				<td><input type="text" name="districtLevel" id="districtLevel" placeholder="这里输入区域级别" value="" title="区域级别" maxlength="32" /></td>
			</tr>
			<tr>
