...
<body>
	<form  action="<%=basePath%>staffLevel/staffSaveOrUpdate.do" name="staffForm" id="staffForm" enctype="multipart/form-data" method="post" >
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				...
				<td style="width:120px;text-align: left;padding-top: 13px;"><input disabled="disabled" type="text" name="staffName" id="staffName" placeholder="这里输入员工姓名" value="${staff.staffName }" title="员工姓名"   maxlength="32"  /></td>
			</tr>
			<tr>	
				<td style="width:120px;text-align: right;padding-top: 13px;">身份证号：</td>
				<td style="width:120px;text-align: left;padding-top: 13px;"><input disabled="disabled" type="text" name="staffIdcard" id="staffIdcard" placeholder="这里输入身份证号" value="${staff.staffIdcard }" title="身份证号"   maxlength="32" /></td>
				<td style="width:120px;text-align: right;padding-top: 13px;">联系电话：</td>
				<td style="width:120px;text-align: left;padding-top: 13px;"><input disabled="disabled" type="text" name="staffPhone" id="staffPhone" placeholder="这里输入联系电话" value="${staff.staffPhone }" title="联系电话"   maxlength="32" /></td>
			</tr>
			<tr>	
				<td style="width:120px;text-align: right;padding-top: 13px;">员工性别：</td>
				<td style="width:120px;text-align: left;padding-top: 13px;"><select disabled="disabled" name="staffSex" id="staffSex" class="chzn-select" data-placeholder="请选择员工性别" style="vertical-align:top;width: 220px;"  title="员工性别">
								<option value=""></option>
				...
				<input disabled="disabled" class="span10 date-picker" name="staffInDate" style="width:205px;"  
					value="${staff.staffInDate}" type="text" data-date-format="yyyy-mm-dd" 
					style="width:88px;" placeholder="入职日期" title="入职日期"/></td>
			</tr>
			<tr>	
				<td style="width:120px;text-align: right;padding-top: 13px;">员工所属职务：</td>
				<td style="width:120px;text-align: left;padding-top: 13px;">
					<select disabled="disabled" name="dutyCode" id="dutyCode" class="chzn-select" data-placeholder="请选择员工所属职务" 
				...
				<td style="width:120px;text-align: right;padding-top: 13px;">员工岗位级别：</td>
				<td style="width:120px;text-align: left;padding-top: 13px;">
					<select  name="jobLevel" id="jobLevel" class="chzn-select" data-placeholder="请选择员工岗位级别"
							style="vertical-align:top;width: 220px;" title="员工岗位级别" >
						<systab:dataDictionary codeType="job_level" valueType="all">
							<option value="${dataDictionary.valuetype}"  ${dataDictionary.valuetype==staff.jobLevel ? 'selected="selected"' : '' }>${dataDictionary.valuename}</option>
						</systab:dataDictionary>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td style="width:120px;text-align: left;padding-top: 13px;"><input disabled="disabled" type="text" name="remark" id="remark" placeholder="这里输入备注" value="${staff.remark}" title="备注" /></td>
			</tr>
			<tr>
