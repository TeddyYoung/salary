...
<script type="text/javascript">
	...
	//添加员工成本信息信息
	function saveOrUpdateStaffCost() {
		window.location.href = "<%=basePath%>staffCost/saveOrUpdateStaffCost.do";
	}
	...
	function importStaffData() {
		bootbox.confirm("当前上传的Excel表格会自动将数据录入至上个月的数据中，请确认您上传的Excel表格是上个月的数据！", function(result) {
			if(result) {
				$("#staffCostForm").attr("action", "<%=basePath%>staffCost/importStaffData.do");
				$("#staffCostForm").submit();
			}
		});
	}
	...
	<div class="container-fluid" id="main-container">
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				<div class="row-fluid">
					<!-- 检索  -->
					<form action="<%=basePath%>staffCost/staffCostList.do" name="staffCostForm" 
						...
						<table>
							<tr>
								...
								<td style=""><a
									class="btn btn-mini btn-info" onclick="saveOrUpdateStaffCost();" style="margin-top:-11px;">维护员工成本</a></td>
<!-- 								<td> -->
<!-- 									<input id="uploadFile" type="file" name="uploadFile" /> -->
<!-- 									<a class="btn btn-mini btn-info" onclick="importStaffData();" style="margin-top:-11px;">员工数据上传</a> -->
<!-- 								</td> -->
							</tr>
						</table>
