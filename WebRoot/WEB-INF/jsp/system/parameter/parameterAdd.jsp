	...
	<form  action="parameter/parameterSaveOrUpdate.do" name="parameterForm" id="parameterForm" method="post" >
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				...
				<td><input type="text" name="parameterKey" id="parameterKey" placeholder="这里输入参数的键" value="" title="参数的键"  maxlength="32" /></td>
				<td style="width:120px;text-align: right;padding-top: 13px;">参数的值：</td>
				<td><input type="text" name="parameterValue" id="parameterValue" placeholder="这里输入参数的值" value="" title="参数的值"  maxlength="32" /></td>
			</tr>
			<tr>
				...
				<td style="width:120px;text-align: right;padding-top: 13px;">参数类型名称：</td>
				<td><input type="text" name="parameterTypeName" id="parameterTypeName" placeholder="这里输入参数类型名称" value="" title="参数类型名称"  maxlength="32" /></td>
			</tr>
			<tr>
